...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in IndexerParams) DeepCopyInto(out *IndexerParams) {
	{
		in := &in
		*out = make(IndexerParams, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IndexerParams.
func (in IndexerParams) DeepCopy() IndexerParams {
	if in == nil {
		return nil
	}
	out := new(IndexerParams)
	in.DeepCopyInto(out)
	return *out
}
